...
regno = raw_input("Enter Registeration No.")
url = "http://evarsity.srmuniv.ac.in/srmwebonline/exam/onlineResultInner.jsp?registerno="+regno+"&iden=1&frmdate="+"1997-03-25"
...
# Something is wrong in the generate XML function! Printing it for now
print result
#generateXML(result)
